...
data = dict(
    train=dict(
        ...
        dataset=dict(
            ...
            cache_path=feat_root + 'clip_features_mot17',
            query_path=feat_root + 'clip_text_features_mot17',
            use_cache=True,
            min_video_len=5,
            fps=0.5,
            unit=2),
    ...
    val=dict(
        ...
        cache_path=data_root + 'clip_features_mot17',
        query_path=data_root + 'clip_text_features_mot17',
        use_cache=True,
        fps=0.5,
        unit=2,
